...
public class Tab_Home_Fragment extends Fragment implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Tìm button mới bằng id của nó

        buttonLogout = view.findViewById(R.id.button_on_advertisement);

        if (isLoggedIn) {
            buttonLogout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    // Xử lý các hành động khi button mới được nhấn
                    handleButtonLogoutClick();
                }

                private void handleButtonLogoutClick() {
                    SharedPreferences sharedPreferences = getActivity().getSharedPreferences("myPrefs", Context.MODE_PRIVATE);
...
//                startActivity(intent);
                Toast.makeText(getActivity(), "Mẹo thi!!!", Toast.LENGTH_SHORT).show();
            }
        });
...
//                startActivity(intent);
                Toast.makeText(getActivity(), "Biển báo!!!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.menu_toobar_nav, menu);
    ...
    private void ActionViewFlipper() {
        ...
        mangquangcao.add("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStVrsZb0sTIkIJY0Zi3zl1Eu_hEC3Kmvjy8w&s");
        mangquangcao.add("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkasSv1OA16cCChMoQZBv4pqqjPZ6MZVOGAw&s");
        mangquangcao.add("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnQsQNvis1igzsj-XtHiwpf0NUgk9Y6v_9Uw&s");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            // Chuyển hướng đến màn hình đăng nhập hoặc màn hình chào mừng
            Intent intent = new Intent(getActivity(), LoginActivity.class);
            startActivity(intent);
            getActivity().finish();
        }
